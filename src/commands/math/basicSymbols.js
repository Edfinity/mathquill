...
(function() {
  var mostOps = ('arg deg det dim exp gcd hom infinity inf ker lg lim ln log max min sup'
  ...
  var autoTrigs = 'asin acos atan sin cos tan sec cosec csc cotan cot ctg'.split(' ');
